/**
 * @author RookieHPC
 * @brief Original source code at https://rookiehpc.github.io/mpi/docs/mpi_ibcast/index.html
 **/
...
int main(int argc, char* argv[])
{
    ...
    MPI_Ibcast(&buffer1, 1, MPI_INT, broadcast_root, MPI_COMM_WORLD, &request);
